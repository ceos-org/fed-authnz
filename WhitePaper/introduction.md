...
WGISS activities, including Connected Data Assets and common discovery best practices, help users locate resources distributed across agencies. The [CEOS Interoperability Handbook](https://github.com/ceos-org/interoperability-handbook/blob/main/Interface.md) complements this work promoting a common framework for improving the interoperability of EO data and services, including recommendations for authentication and authorization based on open standards. Together, these activities provide the context for addressing a further challenge: enabling users and applications to move consistently and securely from discovering resources to using them.
